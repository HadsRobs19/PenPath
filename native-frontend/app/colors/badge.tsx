...
export default function ColorsBadge() {
  ...
  useEffect(() => {
    async function checkCompletion() {
      const lessonComplete = await AsyncStorage.getItem('lesson1Complete');
  ...
  const handleNextLesson = async () => {
    await AsyncStorage.setItem('colorsLessonComplete', 'true');
    router.push('/animals/reading' as Href);
  };
